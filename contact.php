       ...
       <div class="row">
            <div class="col-lg-12 text-center">                
                <div class="col-md-12 my-auto">
                    <p class="p1 vision-statement">If you are looking for a school where your child will be happy, healthy, and successful, look no further than The Msingi School Academy. Contact us today to learn more and schedule a tour of our facilities. We can't wait to meet you and your little one!</p>           
                </div> 
            ...
            <div class="col-lg-6">
                ...
                <form class="mt-3" name="contact-us-form" method="post">
                    <div class="form-floating my-3 mx-3">                
                        <input id="floatingInput" class="form-control w-75" type="text" name="client-name" required placeholder="Name">
                        <label for="floatingInput" class="label">Name</label>                
                    </div>
                    <div class="form-floating mb-3 mx-3">                
                        <input id="floatingInput" class="form-control w-75" type="text" name="email" required placeholder="E-Mail"> 
                        <label for="floatingInput" class="label">E-Mail</label>               
                    </div>
                    <div class="form-floating mb-3 mx-3">                
                        <input id="floatingInput" class="form-control w-75" type="text" name="subject" required placeholder="Subject">
                        <label for="floatingInput" class="label">Subject</label>                
                    </div>
                    <div class="form-floating mb-3 mx-3">                
                        <textarea id="floatingTextArea" class="form-control w-75" style="height: 6rem;" placeholder="Leave a message" name="message" required></textarea>
...
?>
            ...
            <div class="col-lg-6">
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d416.25528414775164!2d34.787427000332265!3d-0.05259542873672621!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sen!2ske!4v1625757050258!5m2!1sen!2ske" width="100%" height="100%" style="border:0;" allowfullscreen="" loading=""></iframe>
            </div>
       </div>
    </div>
</div>
        ...
        <div class="container-fluid text-md-left my-0">
                <div class="row py-4 d-flex">
                    <div class="col-md-4 mx-auto mb-4">                        
                        ...
                        <div class="socials">                        
                            <a href="https://www.facebook.com/themsingischoolacademy" class="mx-1" target="_FB" rel="noreferrer, noopener"><i class="fa fa-facebook mr-4" aria-hidden="true" style="font-size: 2rem;"></i></a>
                            <a href="https://www.instagram.com/themsingischoolacademy_/" class="mx-1" target="_IG" rel="norefereer, noopener"><i class="fa fa-instagram mr-4" aria-hidden="true" style="font-size: 2rem;"></i></a>
                        </div>                                                
                    </div>                    
                    <div class="col-md-4 mx-auto mb-4">
                    ...
                    <div class="col-md-4 mx-auto mb-4">
                        ...
                        <hr class="bg-succes mb-4 mt-0 d-inline-block mx-auto" style="width: 150px; height: 2px;">
                            <ul class="list-unstyled">
                                <li class="my-2"><i class="fa fa-map-marker" aria-hidden="true"><span class="mx-2">MAMBOLEO, KISUMU KENYA</span></i></li>
                                <li class="my-2"><i class="fa fa-phone" aria-hidden="true"><a href="tel:{+254722620416}" class="mx-2">+254722620416</a></i></li>
                                <li class="my-2"><i class="fa fa-envelope" aria-hidden="true"><a href="mailto:{info@themsingiacademy.co.ke}" class="mx-2">info@themsingiacademy.co.ke</a></i></li>                               
                            </ul>
                    </div>
                </div>                              
        </div>
        <div class="container-fluid my-0 mx-0">
            <div class="row-fluid">
              <div class="col-md-12 text-center">
                <p class="my-0 pt-0 mx-auto">&copy;<script>document.write(new Date().getUTCFullYear());</script> The Msingi School Academy.</p>
              </div>
            </div>
        </div>
        <div class="container-fluid footer-copyright my-0 mx-0">
            <div class="row-fluid">
                <div class="col-md-12 d-flex justify-content-end">
                    <p class="my-0 pt-0 mx-auto p2">Made by <a href="https://borisochieng.dev" style="text-decoration: underline;" target="_BORIS" rel="noreferrer, noopener">boris</a>.</p>
                </div>
            </div>
        </div>                                  
    </footer>
